...
export default function FaleConosco() {
  const { data: faleConosco, loading, error, refetch } = useContent<IFaleConosco>("fale-conosco/fale-conosco")
    ...
    <div className="min-h-screen bg-altm-page">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center py-16">
          ...
          <p className="text-gray-600 mb-6">Não foi possível carregar as informações sobre fale conosco.</p>
          <button 
            onClick={() => refetch()}
