...
export default function Inscricoes() {
  const { data: inscricoes, loading, error, refetch } = useContent<IProgramacaoCultural>("inscricoes")

  if(loading) return (
    <div className="min-h-screen bg-altm-page">
      <PageHeader 
        title="Inscrições"
        subtitle="Carregando informações sobre inscrições"
        icon={<FaEdit size={50} />}
        breadcrumb={[
          { label: "Home", href: "/" },
    ...
    <div className="min-h-screen bg-altm-page">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center py-16">
          ...
          <p className="text-gray-600 mb-6">Não foi possível carregar as informações sobre inscrições.</p>
          <button 
            onClick={() => refetch()}
            ...
            <Card>
              <div className="space-y-6">
                <div className="flex items-center space-x-3 mb-6 justify-center">
                  <h2 className="text-2xl text-center font-bold text-gray-800">Inscrições</h2>
                </div>
