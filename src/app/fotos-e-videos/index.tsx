...
export default function FotosEVideos() {
  ...
  const albumsComVideos = useMemo(
    () => albums.filter((galeria) => galeria.video_url),
    [albums]
  )
        ...
        <div className="space-y-14">
          <section>
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-gray-900">Galerias de Fotos</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {albumsComVideos.map((video) => {
                  const thumbnail =
                    ...
                    video.imagem_destacada ||
                    "https://placehold.co/600x400?text=Sem+imagem"

                  const Wrapper = video.video_url ? "a" : "div"
                  ...
                  return (
                    <Wrapper
                      ...
                      {...(video.video_url
                        ...
                        : {})}
                      className={video.video_url ? "block" : "block cursor-default"}
                    >
                      <Card className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 flex flex-col h-full">
                        ...
                        <div className="p-6 flex flex-col gap-4 flex-1">
                          ...
                          <div className="flex items-center justify-between text-sm text-gray-500 mt-auto">
                            ...
                            <span className="text-altm-gold-600 font-semibold">
                              {video.video_url ? "Assistir vídeo" : "Em breve"}
                            </span>
                          </div>
                        </div>
                      </Card>
        ...
        {!loading && albums.length === 0 && !error && (
          <div className="text-center py-20">
            ...
            <p className="text-gray-600 max-w-xl mx-auto">
              Em breve adicionaremos novas fotos e vídeos para compartilhar com
              você os momentos especiais da Academia.
            </p>
          </div>
        )}
      </div>
