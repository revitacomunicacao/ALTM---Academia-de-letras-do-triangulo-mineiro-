...
import { IRegimento } from "./types/IRegimento"
...
export default function Regimento() {
  const { data: regimento, loading, error, refetch } = useContent<IRegimento>("regimento")

  if(loading) return (
    <div className="min-h-screen bg-altm-page">
      <PageHeader 
        title="Regimento"
        subtitle="Carregando informações sobre o regimento da ALTM"
        icon={<FaBook size={50} />}
        breadcrumb={[
          { label: "Home", href: "/" },
    ...
    <div className="min-h-screen bg-altm-page">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center py-16">
          ...
          <p className="text-gray-600 mb-6">Não foi possível carregar as informações sobre o regimento da ALTM.</p>
          <button 
            onClick={() => refetch()}
              ...
              <Card>
                <div className="space-y-6">
                  <div className="flex items-center space-x-3 mb-6 justify-center">
                    <h2 className="text-2xl text-center font-bold text-gray-800">Regimento da ALTM</h2>
                  </div>
